...
public class MapleAesOfb {
    ...
    public MapleAesOfb(byte[] iv, short mapleVersion) {
        try {
            ...
            throw new RuntimeException(String.format("Cypher initialization error with skey: %s", skey), e);
        }
    ...
    /**
     * Encrypts the data using the current IV. And update the IV for the next packet!
     *
